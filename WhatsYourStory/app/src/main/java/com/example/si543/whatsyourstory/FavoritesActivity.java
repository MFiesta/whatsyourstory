...
/**
 * Created by alicerhee on 10/21/14.
 */
/*
public class FavoritesActivity extends Activity{

    // the string variable we use for sending messages with intents
    public final static String EXTRA_MESSAGE = "edu.umich.whatsyourstory.MESSAGE";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        int id = item.R.id.action_favorites){
            // launch intent to go to favorites
    }

    */
>>>>>>> choose-skills-and-interests
